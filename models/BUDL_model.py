...
class BUDL(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 , img_range=1., trainning=True, withzero=False,
                 **kwargs):
        ...
        if not self.withzero:
            ...
            self.Tran1u = TransformerBlock_withZeromap(dim=int(32), num_heads=2,
                                                         ffn_expansion_factor=2, bias=False,
                                                         LayerNorm_type='WithBias', N=4)
            self.Tran2u = TransformerBlock_withZeromap(dim=int(64), num_heads=2,
                                                         ffn_expansion_factor=2, bias=False,
                                                         LayerNorm_type='WithBias', N=4)
            self.Tran3u = TransformerBlock_withZeromap(dim=int(64), num_heads=4,
                                                         ffn_expansion_factor=2, bias=False,
                                                         LayerNorm_type='WithBias', N=8)
            self.Tran4u = TransformerBlock_withZeromap(dim=int(64), num_heads=8,
                                                         ffn_expansion_factor=2, bias=False,
                                                         LayerNorm_type='WithBias', N=8)
